...
<body id="top" class="index-body">
    ...
    <noscript><iframe src="https://www.googletagmanager.com/ns.html?id=GTM-PDTWJ3Z" height="0" width="0" style="display:none;visibility:hidden"></iframe>
    </noscript>
    ...
    <script src="{{asset('assets/front/js/backstretch.')}}"></script>
